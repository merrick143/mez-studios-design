...
def main() -> int:
    ...
    required = [
        ...
        BRAND_KIT / "llm/tasks/TASK-FND-02-COLOUR-SURFACES.json",
        BRAND_KIT / "llm/tasks/TASK-FND-03-SPACE-LAYOUT.json",
        BRAND_KIT / "llm/tasks/TASK-FND-04-GEOMETRY-CONTROLS.json",
        BRAND_KIT / "llm/tasks/TASK-FND-05-FOUNDATION-RELEASE.json",
