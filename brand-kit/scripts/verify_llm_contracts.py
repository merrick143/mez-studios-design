...
def main() -> int:
    ...
    print("- FND-01 through FND-05, EXP-01/02/03/04/05/07/08, CMP-01, GOLD-01, PORT-01/02/03/04, FIG-01, UI-01 and CERT-01 are complete; CHAN-01 is priority-deferred")
    return 0
