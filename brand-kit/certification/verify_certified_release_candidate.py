...
def main() -> int:
    ...
    print("- the immutable package retains its pre-gate H-CERT snapshot; external approval is manifest-bound")
    print("- publication, deployment and consumer integration remain pending")
    return 0
