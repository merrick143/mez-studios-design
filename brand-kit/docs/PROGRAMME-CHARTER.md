...
Status: approved programme charter; migration-first amendment active
Version: 0.2.0
...
The completed pre-cutover contract is preserved under `../history/mezcorp-2026-07-21/governance/MIGRATION-FIRST-GATE.md`. Current work is routed through `CURRENT-STATE.md` and `ROADMAP.md`. The original phase outcomes remain valid; unfinished work continues in this repository rather than blocking the completed cutover.

## Original H0 questions and continuing ownership work

The migration sequence, authority model, identity kernel, and current human decision rights are approved. The following operational ownership questions remain to be assigned as the programme expands:
...
The original response form is preserved in `../history/mezcorp-2026-07-21/governance/H0-DECISION-PACKET.md`.
