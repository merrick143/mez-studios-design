...
1. `brand-kit/authority/current.json`, the immutable `brand-kit/governance/decisions.json` cutover ledger and `brand-kit/governance/post-cutover-decisions.json`: approved decisions
