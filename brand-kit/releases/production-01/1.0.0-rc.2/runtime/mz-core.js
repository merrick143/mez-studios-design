...
const DEFAULT_CATALOGUE = new URL("../identity/runtime-gradients.json", import.meta.url);
const DEFAULT_STATIC_BASE = new URL("../identity/gradients/", import.meta.url);
const DEFAULT_WINGS = new URL("../identity/wings.svg", import.meta.url);
