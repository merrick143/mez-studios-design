...
2. Read `START-HERE.md` and `HANDOFF.md`.
3. Read `products.json`, `manifest.json`, and the relevant numbered brand-system documents.
4. Open the local Canvas and inspect the current rendered state.
...
Read `governance/MIGRATION-FIRST-GATE.md` and `governance/tasks/TASK-MIGRATION-CUTOVER-01.json` before using the older phase sequence for repository decisions.
