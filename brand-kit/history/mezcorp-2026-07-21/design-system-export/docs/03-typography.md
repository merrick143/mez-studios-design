...
> **LOCKED (2026-07-10):** the family is **Inter** (Notion-tuned), with **Instrument Serif** as an occasional editorial accent and **IBM Plex Mono** for code. Headings are **Inter Bold** with negative tracking + tight leading (H1 -3%/lh100, H2 -2.5%/lh104). Full scale also in [`../typography.md`](../typography.md). The earlier SF Pro exploration is superseded (see history at the bottom).
